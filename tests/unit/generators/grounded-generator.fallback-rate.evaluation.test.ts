...
const CASES: Case[] = [
  ...
  ...["Bananas are a good source of potassium.", "The stock market closed higher today.",
      "Photosynthesis converts sunlight into energy.", "The Eiffel Tower is in Paris.",
      "Cats are obligate carnivores."].map((context, i) => ({
    label: `off-topic-${i + 1}`,
    context,
  ...
  ...["The company was founded in 2010 and is based in Berlin.",
      ...
      "The conference will be held in the fall."].map((context, i) => ({
