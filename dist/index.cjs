...
__export(index_exports, {
  ...
  GroundedCall: () => GroundedCall,
  GroundedGenerator: () => GroundedGenerator,
  InvalidModelOutputError: () => InvalidModelOutputError,
...
var import_error = require("openai/error.mjs");
...
var GroundedCall = class {
  ...
  async callModel(params) {
    ...
    try {
      ...
      if (error instanceof import_error.LengthFinishReasonError || error instanceof import_error.ContentFilterFinishReasonError) {
...
var import_zod2 = require("openai/helpers/zod.mjs");

// src/generators/schema.ts
var import_zod = require("zod");
var groundedGenerationSchema = import_zod.z.object({
  extracted_facts: import_zod.z.array(import_zod.z.string()),
  sufficient_context: import_zod.z.boolean(),
  reasoning: import_zod.z.string(),
  final_answer: import_zod.z.string()
});
...
var GroundedGenerator = class extends GroundedCall {
  ...
  async generate(request) {
    ...
    const output = await this.callModel({
      ...
      response_format: (0, import_zod2.zodResponseFormat)(groundedGenerationSchema, "grounded_generation"),
      messages: [
